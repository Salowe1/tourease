...
class DestinationDetails extends StatelessWidget {
  ...
  void _navigateToPayment() {
    Get.toNamed(MyRoutes.payment, arguments: destination.price);
  }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      Text(destination.location, style: TextStyle(color: Colors.grey)),
                      Spacer(),
                      Text(
                        '${destination.price.toStringAsFixed(2)} FCFA',
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: customPrimary,
